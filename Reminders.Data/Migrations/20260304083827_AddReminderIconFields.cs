...
{
    /// <inheritdoc />
    public partial class AddReminderIconFields : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomIconUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    OccursAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeZoneId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsPaused = table.Column<bool>(type: "bit", nullable: false),
                    RecurringInterval = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "None"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReminderChannels_Reminders_ReminderId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AllowedChannelsJson", "BillingInterval", "FreeNotificationQuota", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "[\"Email\",\"Push\"]", "Monthly", 10, "Free", 0m },
                    { 2, "[\"Email\",\"Push\",\"SMS\",\"Voice\"]", "Monthly", 1000, "Pro", 9.99m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReminderChannels_ReminderId",
                table: "ReminderChannels",
                column: "ReminderId");
